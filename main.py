...
try:
    ...
    icon_image = Image.open('img/app_icon.ico')
...
menu_button4 = tk.Button(left_frame, width=16, bg="#E5E5E5", text="Excel批量转CSV", command=lambda: on_menu_click(menu_button4, lambda: show_excel_to_csv(right_frame, root)))
...
menu_button_last.grid(row=4, column=0, pady=0, sticky="ew")
